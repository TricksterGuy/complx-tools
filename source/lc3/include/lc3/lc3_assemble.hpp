...
enum LC3_API LC3AssembleExceptionTypes
{
    UNKNOWN_ERROR = 0,
    SYNTAX_ERROR,
    ORIG_MATCHUP,
...
struct LC3_API LC3AssembleOptions
{
...
/** lc3_assemble
  ...
  * @throw LC3AssembleException on error
  */
void LC3_API lc3_assemble(lc3_state& state, const std::string& filename, std::vector<code_range>& ranges, const LC3AssembleOptions& options = LC3AssembleOptions());
/** lc3_assemble
  *
  * Assembles a file into the LC3State object given.
  * @param state LC3State object.
  ...
  * @throw LC3AssembleException on error
  */
void LC3_API lc3_assemble(lc3_state& state, const std::string& filename, const LC3AssembleOptions& options = LC3AssembleOptions());
/** lc3_assemble
  *
  ...
  * @throw LC3AssembleException on error
  */
bool LC3_API lc3_assemble(const std::string& filename, const std::string& output_prefix = "", const LC3AssembleOptions& options = LC3AssembleOptions());
...
/** lc3_assemble
  ...
  * @throw LC3AssembleException on error
  */
void LC3_API lc3_assemble(lc3_state& state, std::istream& file, std::vector<code_range>& ranges, const LC3AssembleOptions& options = LC3AssembleOptions());
...
/** lc3_assemble
  ...
  * @throw LC3AssembleException on error
  */
void LC3_API lc3_assemble(lc3_state& state, std::istream& file, const LC3AssembleOptions& options = LC3AssembleOptions());
